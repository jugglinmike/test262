...
es6id: 22.2.3.6
description: >
    "length" property of TypedArrayPrototype.entries
info: >
...
assert.sameValue(TypedArrayPrototype.entries.length, 0);

verifyNotEnumerable(TypedArrayPrototype.entries, 'length');
verifyNotWritable(TypedArrayPrototype.entries, 'length');
verifyConfigurable(TypedArrayPrototype.entries, 'length');
