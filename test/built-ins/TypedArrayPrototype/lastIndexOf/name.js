...
es6id: 22.2.3.16
description: >
    "name" property of TypedArrayPrototype.lastIndexOf
info: >
...
assert.sameValue(TypedArrayPrototype.lastIndexOf.name, 'lastIndexOf');

verifyNotEnumerable(TypedArrayPrototype.lastIndexOf, 'name');
verifyNotWritable(TypedArrayPrototype.lastIndexOf, 'name');
verifyConfigurable(TypedArrayPrototype.lastIndexOf, 'name');
