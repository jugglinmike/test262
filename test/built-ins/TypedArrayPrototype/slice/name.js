...
es6id: 22.2.3.23
description: >
    "name" property of TypedArrayPrototype.slice
info: >
...
assert.sameValue(TypedArrayPrototype.slice.name, 'slice');

verifyNotEnumerable(TypedArrayPrototype.slice, 'name');
verifyNotWritable(TypedArrayPrototype.slice, 'name');
verifyConfigurable(TypedArrayPrototype.slice, 'name');
