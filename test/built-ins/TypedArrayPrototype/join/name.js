...
es6id: 22.2.3.14
description: >
    "name" property of TypedArrayPrototype.join
info: >
...
assert.sameValue(TypedArrayPrototype.join.name, 'join');

verifyNotEnumerable(TypedArrayPrototype.join, 'name');
verifyNotWritable(TypedArrayPrototype.join, 'name');
verifyConfigurable(TypedArrayPrototype.join, 'name');
