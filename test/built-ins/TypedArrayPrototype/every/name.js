...
es6id: 22.2.3.7
description: >
    "name" property of TypedArrayPrototype.every
info: >
...
assert.sameValue(TypedArrayPrototype.every.name, 'every');

verifyNotEnumerable(TypedArrayPrototype.every, 'name');
verifyNotWritable(TypedArrayPrototype.every, 'name');
verifyConfigurable(TypedArrayPrototype.every, 'name');
