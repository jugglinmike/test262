...
es6id: 22.2.3.15
description: >
    "name" property of TypedArrayPrototype.keys
info: >
...
assert.sameValue(TypedArrayPrototype.keys.name, 'keys');

verifyNotEnumerable(TypedArrayPrototype.keys, 'name');
verifyNotWritable(TypedArrayPrototype.keys, 'name');
verifyConfigurable(TypedArrayPrototype.keys, 'name');
