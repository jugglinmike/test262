...
es6id: 22.2.3.15
description: >
    "length" property of TypedArrayPrototype.keys
info: >
...
assert.sameValue(TypedArrayPrototype.keys.length, 0);

verifyNotEnumerable(TypedArrayPrototype.keys, 'length');
verifyNotWritable(TypedArrayPrototype.keys, 'length');
verifyConfigurable(TypedArrayPrototype.keys, 'length');
