...
es6id: 22.2.3.9
description: >
    "name" property of TypedArrayPrototype.filter
info: >
...
assert.sameValue(TypedArrayPrototype.filter.name, 'filter');

verifyNotEnumerable(TypedArrayPrototype.filter, 'name');
verifyNotWritable(TypedArrayPrototype.filter, 'name');
verifyConfigurable(TypedArrayPrototype.filter, 'name');
