...
es6id: 22.2.3.25
description: >
    "name" property of TypedArrayPrototype.sort
info: >
...
assert.sameValue(TypedArrayPrototype.sort.name, 'sort');

verifyNotEnumerable(TypedArrayPrototype.sort, 'name');
verifyNotWritable(TypedArrayPrototype.sort, 'name');
verifyConfigurable(TypedArrayPrototype.sort, 'name');
