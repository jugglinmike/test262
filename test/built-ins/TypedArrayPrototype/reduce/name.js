...
es6id: 22.2.3.19
description: >
    "name" property of TypedArrayPrototype.reduce
info: >
...
assert.sameValue(TypedArrayPrototype.reduce.name, 'reduce');

verifyNotEnumerable(TypedArrayPrototype.reduce, 'name');
verifyNotWritable(TypedArrayPrototype.reduce, 'name');
verifyConfigurable(TypedArrayPrototype.reduce, 'name');
