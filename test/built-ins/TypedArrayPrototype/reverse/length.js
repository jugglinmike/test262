...
es6id: 22.2.3.21
description: >
    "length" property of TypedArrayPrototype.reverse
info: >
...
assert.sameValue(TypedArrayPrototype.reverse.length, 0);

verifyNotEnumerable(TypedArrayPrototype.reverse, 'length');
verifyNotWritable(TypedArrayPrototype.reverse, 'length');
verifyConfigurable(TypedArrayPrototype.reverse, 'length');
