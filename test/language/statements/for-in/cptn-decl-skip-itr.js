...
assert.sameValue(eval('1; for (var b in undefined) { 2; }'), undefined);
assert.sameValue(eval('1; for (var c in null) { }'), undefined);
assert.sameValue(eval('1; for (var d in null) { 2; }'), undefined);
