...
es6id: 22.2.3.14
description: >
    "length" property of TypedArrayPrototype.join
info: >
    ...
    Unless otherwise specified, the length property of a
...
assert.sameValue(TypedArrayPrototype.join.length, 1);

verifyNotEnumerable(TypedArrayPrototype.join, 'length');
verifyNotWritable(TypedArrayPrototype.join, 'length');
verifyConfigurable(TypedArrayPrototype.join, 'length');
