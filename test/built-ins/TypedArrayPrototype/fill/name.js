...
es6id: 22.2.3.8
description: >
    "name" property of TypedArrayPrototype.fill
info: >
...
assert.sameValue(TypedArrayPrototype.fill.name, 'fill');

verifyNotEnumerable(TypedArrayPrototype.fill, 'name');
verifyNotWritable(TypedArrayPrototype.fill, 'name');
verifyConfigurable(TypedArrayPrototype.fill, 'name');
