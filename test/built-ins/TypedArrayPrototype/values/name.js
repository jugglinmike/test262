...
es6id: 22.2.3.29
description: >
    "name" property of TypedArrayPrototype.values
info: >
...
assert.sameValue(TypedArrayPrototype.values.name, 'values');

verifyNotEnumerable(TypedArrayPrototype.values, 'name');
verifyNotWritable(TypedArrayPrototype.values, 'name');
verifyConfigurable(TypedArrayPrototype.values, 'name');
