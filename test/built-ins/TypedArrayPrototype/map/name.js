...
es6id: 22.2.3.18
description: >
    "name" property of TypedArrayPrototype.map
info: >
...
assert.sameValue(TypedArrayPrototype.map.name, 'map');

verifyNotEnumerable(TypedArrayPrototype.map, 'name');
verifyNotWritable(TypedArrayPrototype.map, 'name');
verifyConfigurable(TypedArrayPrototype.map, 'name');
