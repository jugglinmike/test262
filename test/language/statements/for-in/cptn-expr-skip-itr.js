...
assert.sameValue(eval('var b; 1; for (b in undefined) { 2; }'), undefined);
assert.sameValue(eval('var c; 1; for (c in null) { }'), undefined);
assert.sameValue(eval('var d; 1; for (d in null) { 2; }'), undefined);
