...
es6id: 22.2.3.10
description: >
    "name" property of TypedArrayPrototype.find
info: >
...
assert.sameValue(TypedArrayPrototype.find.name, 'find');

verifyNotEnumerable(TypedArrayPrototype.find, 'name');
verifyNotWritable(TypedArrayPrototype.find, 'name');
verifyConfigurable(TypedArrayPrototype.find, 'name');
