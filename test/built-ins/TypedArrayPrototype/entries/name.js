...
es6id: 22.2.3.6
description: >
    "name" property of TypedArrayPrototype.entries
info: >
...
assert.sameValue(TypedArrayPrototype.entries.name, 'entries');

verifyNotEnumerable(TypedArrayPrototype.entries, 'name');
verifyNotWritable(TypedArrayPrototype.entries, 'name');
verifyConfigurable(TypedArrayPrototype.entries, 'name');
