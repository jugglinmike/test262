...
es6id: 22.2.3.29
description: >
    "length" property of TypedArrayPrototype.values
info: >
...
assert.sameValue(TypedArrayPrototype.values.length, 0);

verifyNotEnumerable(TypedArrayPrototype.values, 'length');
verifyNotWritable(TypedArrayPrototype.values, 'length');
verifyConfigurable(TypedArrayPrototype.values, 'length');
