...
es6id: 22.2.3.12
description: >
    "name" property of TypedArrayPrototype.forEach
info: >
...
assert.sameValue(TypedArrayPrototype.forEach.name, 'forEach');

verifyNotEnumerable(TypedArrayPrototype.forEach, 'name');
verifyNotWritable(TypedArrayPrototype.forEach, 'name');
verifyConfigurable(TypedArrayPrototype.forEach, 'name');
