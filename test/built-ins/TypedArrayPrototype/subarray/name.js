...
es6id: 22.2.3.26
description: >
    "name" property of TypedArrayPrototype.subarray
info: >
...
assert.sameValue(TypedArrayPrototype.subarray.name, 'subarray');

verifyNotEnumerable(TypedArrayPrototype.subarray, 'name');
verifyNotWritable(TypedArrayPrototype.subarray, 'name');
verifyConfigurable(TypedArrayPrototype.subarray, 'name');
