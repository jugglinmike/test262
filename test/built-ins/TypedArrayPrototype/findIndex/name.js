...
es6id: 22.2.3.11
description: >
    "name" property of TypedArrayPrototype.findIndex
info: >
...
assert.sameValue(TypedArrayPrototype.findIndex.name, 'findIndex');

verifyNotEnumerable(TypedArrayPrototype.findIndex, 'name');
verifyNotWritable(TypedArrayPrototype.findIndex, 'name');
verifyConfigurable(TypedArrayPrototype.findIndex, 'name');
