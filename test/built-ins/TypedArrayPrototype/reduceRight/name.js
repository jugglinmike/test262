...
es6id: 22.2.3.20
description: >
    "name" property of TypedArrayPrototype.reduceRight
info: >
...
assert.sameValue(TypedArrayPrototype.reduceRight.name, 'reduceRight');

verifyNotEnumerable(TypedArrayPrototype.reduceRight, 'name');
verifyNotWritable(TypedArrayPrototype.reduceRight, 'name');
verifyConfigurable(TypedArrayPrototype.reduceRight, 'name');
