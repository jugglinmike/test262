...
es6id: 22.2.3.24
description: >
    "name" property of TypedArrayPrototype.some
info: >
...
assert.sameValue(TypedArrayPrototype.some.name, 'some');

verifyNotEnumerable(TypedArrayPrototype.some, 'name');
verifyNotWritable(TypedArrayPrototype.some, 'name');
verifyConfigurable(TypedArrayPrototype.some, 'name');
