...
es6id: 22.2.3.25
description: >
    "length" property of TypedArrayPrototype.sort
info: >
...
assert.sameValue(TypedArrayPrototype.sort.length, 1);

verifyNotEnumerable(TypedArrayPrototype.sort, 'length');
verifyNotWritable(TypedArrayPrototype.sort, 'length');
verifyConfigurable(TypedArrayPrototype.sort, 'length');
