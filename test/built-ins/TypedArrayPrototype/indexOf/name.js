...
es6id: 22.2.3.13
description: >
    "name" property of TypedArrayPrototype.indexOf
info: >
...
assert.sameValue(TypedArrayPrototype.indexOf.name, 'indexOf');

verifyNotEnumerable(TypedArrayPrototype.indexOf, 'name');
verifyNotWritable(TypedArrayPrototype.indexOf, 'name');
verifyConfigurable(TypedArrayPrototype.indexOf, 'name');
