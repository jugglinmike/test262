...
es6id: 22.2.3.22
description: >
    "name" property of TypedArrayPrototype.set
info: >
...
verifyNotEnumerable(TypedArrayPrototype.set, 'name');
verifyNotWritable(TypedArrayPrototype.set, 'name');
verifyConfigurable(TypedArrayPrototype.set, 'name');
