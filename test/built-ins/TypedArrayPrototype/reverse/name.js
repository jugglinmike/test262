...
es6id: 22.2.3.21
description: >
    "name" property of TypedArrayPrototype.reverse
info: >
...
assert.sameValue(TypedArrayPrototype.reverse.name, 'reverse');

verifyNotEnumerable(TypedArrayPrototype.reverse, 'name');
verifyNotWritable(TypedArrayPrototype.reverse, 'name');
verifyConfigurable(TypedArrayPrototype.reverse, 'name');
