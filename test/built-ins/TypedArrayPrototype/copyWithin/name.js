...
es6id: 22.2.3.5
description: >
    "name" property of TypedArrayPrototype.copyWithin
info: >
...
assert.sameValue(TypedArrayPrototype.copyWithin.name, 'copyWithin');

verifyNotEnumerable(TypedArrayPrototype.copyWithin, 'name');
verifyNotWritable(TypedArrayPrototype.copyWithin, 'name');
verifyConfigurable(TypedArrayPrototype.copyWithin, 'name');
